...
> Visits on all but nights out at bars are going up over time so the increase expensiture we saw cant all be associated with inflation.
...
accom %>% 
  ...
  theme(panel.border = element_rect(colour = "#700e57", fill=NA, size=3))
```
